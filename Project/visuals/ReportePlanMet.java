...
public class ReportePlanMet extends JFrame {
	...
	private JPanel getJPanel() {
		if (jPanel == null) {
			...
			jPanel.setBounds(new Rectangle(20, 16, 230, 63));
	...
	private JButton getJButton() {
		if (jButton == null) {
			jButton = new JButton();
			jButton.setBounds(new Rectangle(87, 89, 85, 19));
			...
			jButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					Reportes.getR().CargarPlanMet(cod);
					dispose();
...
}  //  @jve:decl-index=0:visual-constraint="188,133"
